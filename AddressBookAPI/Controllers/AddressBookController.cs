...
namespace AddressBookAPI.Controllers
{
    ...
    public class AddressBookController: ControllerBase
    {
        ...
        public IActionResult GetAddressBooks([FromQuery]AddressBookResourceParameter resourceParameter)
        {
        ...
        public IActionResult UpdateAddressBook(Guid addressBookId,[FromBody]AddressBookUpdateParameter addressBookData)
        {
            if (!ModelState.IsValid)
            {
                _log.Error("Invalid addressbook details used.");
        ...
        private string CreateUri(AddressBookResourceParameter resourceParameter,UriType uriType)
        {
            switch (uriType)
            {
